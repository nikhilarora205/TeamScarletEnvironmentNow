...
class Landing extends Component {
    ...
    if(this.address == "") this.address = "11111";

    this.setState.apiResponse = null;
    // console.log(this.state.apiResponse);
    const response = fetch('/api/getValid/'+this.address).then(res => res.text())
...
compare2 = () => {
    ...
    if(this.address == "") this.address = "11111";
    if(this.address2 == "") this.address2 = "11111";
...
.then(res => this.setState({ apiResponse: res }, function() {
        ...
        if(this.state.apiResponse === "incorrect") window.alert("The address entered is incorrect. Please try again.")
            ...
            // console.log(this.state.apiResponse);
            const response2 = fetch('/api/getValid/'+this.address2).then(res => res.text())
...
render() {
    ...
    <img src={air} style={imageStyle} alt="air"/>, Allergen
    <img src={allergy} style={imageStyle} alt="pollen"/>, Water
